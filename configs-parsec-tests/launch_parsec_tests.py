...
experiments_repo = Artifact.registerArtifact(
    command="git clone https://github.com/ShafinKhadem/CXL-consistency-tax.git",
    typ="git repo",
    name="parsec-tests",
    path="./",
    cwd="../",
...
gem5_repo = Artifact.registerArtifact(
    ...
    path="gem5/",
    cwd="./",
    documentation="cloned gem5 stable branch from github (9 April, 2026)",
)
...
gem5_binary = Artifact.registerArtifact(
    command="scons build/ALL/gem5.opt",
    typ="gem5 binary",
    name="gem5",
    cwd="gem5/",
    path="gem5/build/ALL/gem5.opt",
    inputs=[
        gem5_repo,
    ],
